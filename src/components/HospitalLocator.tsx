const handleQueryOverpass = async (targetCoords = gpsCoordinates, isGpsMode = false) => {
  ...
  // Try multiple Overpass endpoints in case one is slow
  ...
  const fallbackPlaces: HealthcarePlace[] = [
    {
      ...
      lat,
      lng,
      address: 'Tap "GPS Route" to open Google Maps with real hospitals near your location',
      type: 'hospital',
      phone: '112',
    ...
    },
    {
      ...
      lat,
      lng,
      address: '24/7 Emergency cardiac care facilities — opens in Google Maps',
      type: 'emergency_room',
      phone: '108',
    ...
    },
    {
      ...
      lat,
      lng,
      address: 'Cardiologists and heart specialty centers near you — opens in Google Maps',
      type: 'hospital',
      phone: '104',
    ...
    },
    {
      ...
      lat,
      lng,
      address: 'General clinics and health centers in your area — opens in Google Maps',
      type: 'clinic',
      phone: undefined,
